...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/sharedRegulation_30M_10M_readDepth.pdf", plot = sharedRegulation_scatterPlot4, width = 5.65, height = 5.65, units = "cm")
```
...
modDir = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/U2AF2/Modulize/read_depth"
...
# significantEvents_2J$A5SS_1M # A5SS_1M führt zu NULL ?? --> es gibt keine signifikanten spleißereignisse
...
'ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/nEventTypes_RD.pdf", plot = nEventTypes_cols, width = 16.5, height = 7, units = "cm")
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/distrEventTypes_RD.pdf", plot = nEventTypes_StackedBarChart, width = 6, height = 7, units = "cm")'
