...
Influence on the size of detected splicing changes is determined by plotting the cumulative fraction 
of dPSIs and probability changing values for each read length. 
