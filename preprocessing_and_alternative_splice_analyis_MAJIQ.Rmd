...
![](C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/figures/workflow.png){width=70%}
...
### <span style="color:#2C5753"> **6.1 `majiq build`** - LSV detection `r knitr::asis_output("&#x1F50E;")`  &nbsp; &nbsp; <span style="color:#2373F6"> 
***
