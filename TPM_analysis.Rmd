...
htseqDir_RL_100 = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/06_htseq_count/read_length/100/nonunique_all"
...
htseqDir_SS = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/06_htseq_count/sample_size"
...
dpsiDir_RL = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/U2AF2/MAJIQ/read_length"
dpsiDir_RD = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/U2AF2/MAJIQ/read_depth"
dpsiDir_SS = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/endodermal_cell_vs_H1_cell_line/MAJIQ"
...
gtf <- rtracklayer::import("C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/gencode.v41.annotation.gtf", format = "gtf")
...
# TPMs for all genes that have (significant) LSVs on them against dPSIs

In this context, "All dPSIs" means that several dPSIs are shown for a gene (as there are several LSVs on the gene). "Maximum dPSIs" means that only the largest dPSI is shown for a gene.
...
1. schauen wie man am besten binned (dafür die gesamten TPM Werte anschauen)
2. in data frame neue spalte einfügen mit bin und dann für jede zeile entsprechenden bin zuordnen
3. stacked bar chart mit unterschiedlichen farben für unterschiedliche bins

## For each read length

hier noch anzahl gene hinter die intervalle mit den bins dazu schreiben
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/TPMs_RL.pdf", plot = fractionTPMs_RL, width = 5.15, height = 7, units = "cm")
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/TPMs_line_plot_RL.pdf", plot = fractionTPMs_RL, width = 7, height = 4.5, units = "cm")
```
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/TPMs_RD.pdf", plot = fractionTPMs_RD, width = 6.4, height = 7, units = "cm")
```
# transform bar plot into line plot
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/TPMs_line_plot_RD.pdf", plot = fractionTPMs_RD, width = 8.75, height = 4.5, units = "cm")
```
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/TPMs_SS.pdf", plot = fractionTPMs_SS, width = 4.55, height = 7, units = "cm")
```
# transform bar plot into line plot
