---
title: "MAJIQ analysis read depth"
...
dpsiDir = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/U2AF2/MAJIQ/read_depth"
...
# save ggplots
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/nLSVs_bar_read_depth.pdf", plot = nLSVs_bar_read_depth, width = 4.62, height = 6, units = "cm")
```
...
'StackedBarChart_nJunctions = 
  ggplot(nJunctions_df, aes(fill = junctionsPerLSV, y = Freq, x = readDepth)) + 
    geom_bar(position="fill", stat="identity") +
    scale_fill_brewer(palette = "Blues", name = "Junctions per LSV", labels = c("2", "3", "4", "> 4")) +
    scale_x_discrete(labels = c("1", "2.5", "5", "10", "15", "20", "25", "30")) +
    xlab("read depth [MM]") +
    ylab("% LSVs") +
    ggtitle("Complexity of LSVs") +
...
# save ggplots
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/complexityLSVs_readDepth.pdf", plot = StackedBarChart_nJunctions, width = 4.45, height = 6, units = "cm")

```

# Regulated LSVs
## Fraction significant regulated LSVs 
```{r, warning=FALSE,message=FALSE,error=FALSE,fig.keep='all'}
...
# add new column called "significant" for each read length which could be TRUE/FALSE 
...
# save plots
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/significantLSVs_readDepth_absolute.pdf", plot = nSignificantLSVs_bar_absolute, width = 4.5, height = 6, units = "cm")
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/significantLSVs_readDepth_relative.pdf", plot = nSignificantLSVs_bar_relative, width = 4.48, height = 6, units = "cm")
...
ecdf_deltaPSI = ggplot() +
  ...
  scale_color_manual(name = "read depth  [MM]", values = c(lighten("#2DACA4", 0.95), lighten("#2DACA4", 0.9), lighten("#2DACA4", 0.6), lighten("#2DACA4", 0.3), 
                                                           "#2DACA4", "#36716E", darken("#36716E",0.3), darken("#36716E",0.6)), 
                     labels = c("1", "2.5", "5", "10", "15", "20", "25", "30")) + 
...
# save ggplots
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/ecdf_dPSI_readDepth.pdf", plot = ecdf_deltaPSI, width = 4.2, height = 4.2, units = "cm")
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/ecdf_probChanging_readDepth.pdf", plot = ecdf_prob_changing, width = 4.2, height = 4.2, units = "cm")
```
...
pdf(file="C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/upset_read_depth.pdf", width=8, height=4.3) # or other device
...
sharedRegulation_scatterPlot4 = ggplot(data=correlationDataFrame_30M_vs_10M, aes(x=deltaPSI_30M_vs_10M, deltaPSI_10M_vs_30M)) +
  ...
  ggrastr::geom_point_rast(data=correlationDataFrame_30M_vs_10M_sig, aes(x=deltaPSI_30M_vs_10M_sig, y=deltaPSI_10M_vs_30M_sig), color="black", size=0.3) +
...
ggsave(filename = "C:/Users/ladwi/Desktop/HiWi/project_impact_read_length/plots/sharedRegulation_30M_10M_readDepth.pdf", plot = sharedRegulation_scatterPlot4, width = 5, height = 5, units = "cm")
```
